...
//        DateFormat df = DateFormat.getDateInstance();
    ...
    public static void main(String[] args) {
        ...
        System.out.println(checkIDCard("513922198701032395"));
        
        System.err.println("classpath = " + Identity.class.getPackage());
        System.err.println("classpath = " + Identity.class.getResource("/"));
        /*
        String oldID="";
